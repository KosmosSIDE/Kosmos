...
class Import
{
	public:
		...
		static Object* import(const string &filename, int x, int y, int z, int h, int p, int r, int scale, const string &path = "", int type = 2); //used to import into our environment
